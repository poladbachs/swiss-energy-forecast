...
const PRESETS = [
  { label: '❄️ Cold snap',   demandMultiplier: 1.15, bandMultiplier: 1.35 },
  { label: '🏖️ Holiday',     demandMultiplier: 0.88, bandMultiplier: 1.15 },
  { label: '⚡ Event shock',  demandMultiplier: 1.10, bandMultiplier: 1.30 },
  { label: '🌬️ Low wind',    windMultiplier: 0.30,   bandMultiplier: 1.20 },
  { label: '☀️ Low solar',   solarMultiplier: 0.35,   bandMultiplier: 1.20 },
]
