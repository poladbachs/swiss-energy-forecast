...
def test_main_calls_steps_in_order():
    with patch("scripts.retrain_pipeline.ingest") as mock_ingest, \
         patch("scripts.retrain_pipeline.backfill_market") as mock_market, \
         ...
         patch("scripts.retrain_pipeline.run_walkforward") as mock_walkforward, \
         patch("scripts.retrain_pipeline.refresh_price_forecast") as mock_price, \
    ...
    mock_walkforward.assert_called_once()
